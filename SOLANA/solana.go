...
// // GetWalletAddressFromMnemonic derives a Solana wallet address from a mnemonic.
...
// func CreateSignature(mnemonic, message string) (signature, publicKey string, err error) {
// 	seed, err := deriveSeedFromMnemonic(mnemonic, "")
// 	if err != nil {
// 		return "", "", fmt.Errorf("failed to derive seed: %w", err)
// 	}
...
// func Solana(mnemonic string) {
// 	if len(mnemonic) == 0 {
// 		fmt.Println("Please enter a mnemonic")
// 		return
// 	}
// 	message := "Hello, Solana!"

// 	// Get wallet address
// 	address, err := GetWalletAddressFromMnemonic(mnemonic, "")
// 	if err != nil {
// 		fmt.Printf("Error getting wallet address: %v\n", err)
// 		return
// 	}
// 	fmt.Println("Wallet Address:", address)

// 	// Create signature
// 	signature, publicKey, err := CreateSignature(mnemonic, message)
// 	if err != nil {
